...
const indoCateringItems: MenuItem[] = [
  {
    ...
    name: "Bathure Chole",
    description:
      "Fluffy fried bread served with spicy chickpea curry, a classic North Indian combination.",
    price: 10.5,
  ...
  },
  {
    ...
    name: "Dal Makhni",
    description:
      "Rich and creamy black lentils slow-cooked with butter, cream, and aromatic spices.",
    price: 10.5,
  ...
  },
  {
    ...
    name: "Kadhai Paneer",
    description:
      "Fresh cottage cheese cooked with bell peppers, onions, and tomatoes in traditional kadhai spices.",
    price: 10.5,
  ...
  },
  {
    ...
    name: "Rajma Masala",
    description:
      "Red kidney beans cooked in rich tomato-onion gravy with traditional North Indian spices.",
    price: 9.99,
  ...
  },
  {
    ...
    name: "Palak Paneer",
    description:
      "Fresh cottage cheese cubes in a creamy spinach gravy infused with aromatic spices.",
    price: 10.5,
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-8 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white mb-10 px-6 py-10 sm:px-10 rounded-2xl shadow-lg max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">
            Catering Services
          </h2>
          <p className="text-gray-700 text-base sm:text-lg mb-4">
            We offer customized catering solutions to perfectly match your tour
            or event requirements. Whether you need a specific cuisine, dietary
            accommodations, or a unique menu, we can craft it just for you.
          </p>
          <p className="text-gray-700 text-base sm:text-lg">
            From intimate gatherings of 35 people to grand events with up to 250
            guests, we cater for events of all sizes with the same level of
              ...
              <div className="p-6 flex flex-col ">
                ...
                <div className="bg-gradient-to-r from-orange-100 to-red-100 p-3 rounded-lg">
                  <p className="text-sm text-gray-700 self-end">
                    <span className="font-semibold">Perfect for catering:</span>{" "}
                    Available in bulk quantities for events and celebrations.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-8 text-white text-center">
          ...
          <p className="text-lg mb-6 opacity-90">
            Planning an event? We offer bulk orders and catering services for
            all occasions.
          </p>
